...
Adds client-side search and server-side filtering capabilities to the web frontend, allowing users to filter todos by text query (title/description), status, and priority without full page reloads.
